 ...
 * pipe the stream to different pipes of transformers based on field value
 * @param {string} field  holding the value of the sub-pipe
 * @param {array} pipes   array of objects with keys name and transformers
 */
